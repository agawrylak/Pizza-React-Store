...
import {CardHeader, Card, CardActions, Button, CardMedia, CardContent} from '@material-ui/core'
        ...
        <div >
            <Card className={classes.card} >
                    ...
                    <CardActions classes={{root: classes.cardActions}}>
                        <Button className={classes.cardButton} onClick={handleBuy}> Zamów </Button> 
                    </CardActions>
            </Card>
        </div>
    )
